...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isMultiLevelNavigation: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    navItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::navigation.navigation'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTestTest extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::test.test'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    testBool: Schema.Attribute.Boolean;
    TestText: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
